            ...
            <fieldset class="border col-lg-12">
                ...
                <div class="col-lg-12 d-flex">
                    ...
                    <div class="form-group pt-3 col-lg-6">
                        ...
                        <input type="text" class="form-control" id="prenom" name="prenom" value="Entrez le Prénom"
                            required>
                    </div>
                    <!-- Prénom (Arabic) -->
                    <div class="form-group pt-3 col-lg-6">
                        ...
                        <input type="text" class="form-control text-end d-flex flex-row-reverse" id="prenomArab"
                            name="prenomArab" placeholder="أدخل الاسم هنا" value="" required>
                    </div>
                </div>
                <div class="col-lg-12 d-flex">
                    <!-- CIN -->
                ...
                <div class="col-lg-12 d-flex">
                    ...
                    <div class="form-group pt-3 col-lg-6">
                        ...
                        <input name="NumeroDeEmail" type="email" class="form-control" id="inputEmail"
                            placeholder="Entrez le Email" value="">
                    </div>
                </div>
                <div class="col-lg-12 d-flex">
                    <!-- Adress -->
                    <div class="form-group pt-3 col-lg-6">
                        ...
                        <input name="NumeroDeAdress" type="text" class="form-control" id="inputAdress"
                            placeholder="Entrez le Adress" value="">
                    </div>
                    <!-- Ville -->
                    <div class="form-group pt-3 col-lg-6">
                        <label for="inputVille">Ville</label>
                        <input name="NumeroDeVille" type="text" class="form-control" id="inputVille"
                            placeholder="Entrez le Ville" value="">
                    </div>
                </div>
            ...
            <fieldset class="border col-lg-12 mt-4">
                ...
                <div class="col-lg-12 d-flex">
                    <div class="form-group pt-3 col-lg-6 col-6">
                        ...
                        <input name="matricule" type="text" class="form-control" id="inputMatricule"
                            placeholder="Entrez le matricule" value="">
                    </div>
                    <!-- Affectation -->
                    <div class="form-group pt-3 col-lg-6 col-6">
                        <label for="inputAffectation">Affectation</label>
                        <input name="NumeroDeAffectation" type="text" class="form-control" id="inputAffectation"
                ...
                <div class="col-lg-12 d-flex">
                    ...
                    <div class="form-group pt-3 col-lg-6 col-6">
                        ...
                        <input name="NumeroDeAFP de Travail" type="text" class="form-control" id="inputAFP de Travail"
                            placeholder="Entrez le AFP de Travail" value="">
                    </div>
                    <!-- Fonction -->
                    <div class="form-group pt-3 col-lg-6 col-6">
                        <label for="inputFonction">Fonction</label>
                        <input name="NumeroDeFonction" type="text" class="form-control" id="inputFonction"
                            placeholder="Entrez le Fonction" value="">
                    </div>
                </div>
                <div class="col-lg-12 d-flex">
